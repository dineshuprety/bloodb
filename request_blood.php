               ...
               <div class="panel panel-primary">
                  ...
                  <div class="panel-body">
                     ...
                     <?php
                        if(isset($_POST["submit"]))
                        {
                        		...
                        		else
                        		{
                        		 ...
                        		 $sql="INSERT INTO request_blood (NAME, GENDER, BLOOD, BUNIT, HOSP, DISTRICT, DOC, RDATE, CNAME, CADDRESS, EMAIL, CON1, CON2, REASON, PIC, STATUS, CDATE) 
                        		 VALUES('{$_POST["NAME"]}','{$_POST["GENDER"]}','{$_POST["BLOOD"]}','{$_POST["BUNIT"]}','{$_POST["HOSP"]}','{$_POST["DISTRICT"]}','{$_POST["DOC"]}','{$_POST["RDATE"]}','{$_POST["CNAME"]}','{$_POST["CADDRESS"]}','{$_POST["EMAIL"]}','{$_POST["CON1"]}','{$_POST["CON2"]}','{$_POST["REASON"]}','{$target_file}',0,'{$create_at}')";
                        			if($con->query($sql))
                        			{
                     ...
                     <form autocomplete="off" method="post"  action="<?php echo $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                           <label class="control-label text-primary">District</label>
                           <input type="text" required name="DISTRICT" id="DISTRICT" class="form-control" placeholder="Insert District">
                        </div>
                        <div class="form-group">
      ...
      <script>
         $(document).ready(
         	...
         	if($("#BLOOD").val() == "" )
         			...
         			{
         				$("#DISTRICT").focus();
         				$("#errorBox").html("<div class='alert alert-danger fade in' ><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><strong>Warning : </strong> Please Enter Your district name correctly.</div>");
         				return false;
         			}
