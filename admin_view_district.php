...
district On district.PROVINCE_ID = province.PROVINCE_ID  ORDER BY district.DISTRICT_ID";
...
$sql="Select district.DISTRICT_NAME, province.PROVINCE_NAME, district.DISTRICT_ID
From province Inner Join
district On district.PROVINCE_ID = province.PROVINCE_ID  ORDER BY district.DISTRICT_ID DESC  $limit";
									...
									$list.= "<tr>
										...
										while($row=$result->fetch_assoc())
										{
											...
											$list.="<tr>";
												...
												$list.= "<td><a href='admin_del_district.php?id=".$row["DISTRICT_ID"]."' class='btn btn-danger btn-sm'><i class='fa fa-trash'></i></a></td>";
											$list.="</tr>";
										}
								$list.= "</table>";
						}
