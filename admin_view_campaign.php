...
From province Inner Join
  country On province.COUNTRY_ID = country.COUNTRY_ID ORDER BY PROVINCE_ID desc $limit ";
								...
								$list.= "<table class='table table-striped' >";
									$list.= "<tr>
										...
										while($row=$result->fetch_assoc())
										{
											...
											$list.="<tr>";
												$list.= "<td>$i</td>";
                                                $list.= "<td>".$row["CAMPAIGN_NAME"]."</td>";
											    $list.= "<td>".$row["PROVINCE_NAME"]."</td>";
											    $list.= "<td>".$row["DISTRICT_NAME"]."</td>";
											    $list.= "<td>".$row["CONTACT"]."</td>";
												$list.= "<td><a href='admin_del_province.php?id=".$row["PROVINCE_ID"]."' class='btn btn-danger btn-sm'><i class='fa fa-trash'></i></a></td>";
											$list.="</tr>";
										}
								$list.= "</table>";
						}
...
<div class="container">
	<div class="row">
		...
		<div class="col-sm-9" >
			<h3><i class="fa fa-bank"></i> View Campaign Details </h3><hr>    
